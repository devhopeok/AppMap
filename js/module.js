...
.controller('EventsCtrl', function($scope, $http, $ionicPopup, settings) {
    ...
    var eventsFilter = "?$filter=Pending eq false and Status eq 2 and Visibility ne 1 and Visibility ne 4 and Visibility ne 5 and StartTime ge DateTime'" + settings.currentDate + "'" + " and StartTime le Datetime'" + yearLimit + "'"; // filter out pending events and Chamber(1) and Member(4) events
